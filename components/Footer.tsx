...
const Footer: React.FC = () => {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
   ...
   <Image className='m-auto' src={logo1} height={100} width={100} alt='logo'/>
      ...
      <div className="f1 products">
        ...
        <p className="mb-4">
          <a href="/pages" className="text-gray-600">Home</a>
        </p>
        <p className="mb-4">
      ...
      <div className="">
        ...
        <a href='mailto:contact.liefcare@gmail.com' className="flex items-center justify-center md:justify-start mb-4">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> LiefCare</a>
  </div>
</footer></>
  )
}
